...
- [ज्ञानसंग्रह - Personal Knowledge Repository](https://github.com/ArnavGautamGit/gyaana-sangraha) ---> 25 May 2025
	- Designed a website using  [[EleventyJS\|EleventyJS]] to host all my major, non-personal notes that I make on Obsidian so I could learn in public & share my knowledge.
	- Used a community plugin for Obsidian to backup my public notes to the "notes" subfolder of a [Specific GitHub Repo](https://github.com/ArnavGautamGit/gyaana-sangraha) and deployed the website on Netlify.
