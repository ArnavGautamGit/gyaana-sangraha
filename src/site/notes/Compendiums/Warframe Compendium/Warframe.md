...
> Warframe came out in 2013 and is still going strong with a growing community and lore around it. It derives its name after the Warframes - the main suited characters controlled by the player (YOU).

To understand this guide you may need to learn about the [[Complete Lore of Warframe\|Complete Lore of Warframe]] to understand the factions and their characteristics. It allows to understand why certain damage types work better against certain factions. This Background Lore than updates you about how the Universe comes to be. I will not spoil the Second Dream. No matter what. You will have to play the Second Dream to know what the Operator Mode is.

### Tips & Guides for Individual Warframes
[[Compendiums/Warframe Compendium/Frames/Excalibur\|Excalibur]]
[[Volt\|Volt]]
[[Rhino\|Rhino]]
[[Titania\|Titania]]
[[Styanax\|Styanax]]
...
### New Player Guides for the Game
[[Warframe Modding Guide\|Warframe Modding Guide]]
[[Elemental Damage\|Elemental Damage]]

### Advanced Player Guides
[[Condition Overload Mechanic\|Condition Overload Mechanic]]
[[Compendiums/Warframe Compendium/Mechanics/Overlevelling\|Overlevelling]]
[[Compendiums/Warframe Compendium/Weapons/Lich Weapon\|Lich Weapon]]
[[Archon Shards\|Archon Shards]]
[[Incarnon Weapons\|Incarnon Weapons]]
[[Arcanes in Warframe\|Arcanes in Warframe]]


> [!warning] WARNING: HALT! This guide is under rework!
> The guide is under rework! A lot of things have changed over the course of time since this guide was last written and even stuff that has not changed needs to be streamlined.
...
3. ***==Ability Spamming==***: In Warframe, your abilities do the bulk of the heavy lifting and they are part of the power fantasy. It is important to note that your Warframe of choice and the abilities on it affects whether you boost Ability Strength, Ability Duration, Ability Efficiency etc. 

### Modding your Weapons!
1. Ignore the Impact, Puncture and Slash Mods (they are also called IPS mods) for your weapon. They only boost that part of damage for your weapons, instead of adding to the total of damage. If a weapon has a total damage of 200 and 50 of it is from Impact. Putting a mod that increase Impact damage by 100% would raise the damage to 300 since it only doubles the impact damage.
2. Choose Elemental Mods instead of IPS. In the same example as above, a 100% increase of Heat Damage would take the the damage from 200 to 400 since Heat will add to the sum of all damage weapons.
3. Combine Elements to form new ones that have specific abilities. [[Grineer\|Grineer]] are massively vulnerable to [[Corrosive Damage\|Corrosive Damage]] (since it strips armour) and [[Corpus\|Corpus]] are weak to [[Magnetic Damage\|Magnetic Damage]] (since it strips shields)
4. 
